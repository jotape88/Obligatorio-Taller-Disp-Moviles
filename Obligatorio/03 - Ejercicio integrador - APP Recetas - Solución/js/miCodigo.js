 ...
 ******************************/
/* Menu */
function menuLoginHandler() {
    mostrarLogin();
}

function menuRegistroHandler() {
    mostrarRegistro();
}
...
function ocultarSecciones() {
    ...
    $("#divLogin").hide();
    $("#divHome").hide();
    $("#divDetalleReceta").hide();
}

function ocultarOpcionesMenu() {
    $("#btnMenuLogin").hide();
    $("#btnMenuRegistro").hide();
    $("#btnMenuLogout").hide();
}
...
function mostrarHome() {
    ...
    // Le paso una función que dice qué hacer una vez que se hayan cargado las recetas.
    cargarListadoRecetas(function () {
        $("#divHome").show();
    });
}
